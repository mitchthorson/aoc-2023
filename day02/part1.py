...
def solve(input: str) -> int:
    ...
    compare = CubeSample(red=12, green=13, blue=14)
    possible_games = list(filter(lambda g: g.check_sample(compare), games))
    possible_game_ids = [g.id for g in possible_games]
